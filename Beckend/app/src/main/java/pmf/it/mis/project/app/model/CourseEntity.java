...
public class CourseEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "exam_registration_entity_id")
    private ExamRegistrationEntity examRegistration;
    ...
    public ExamRegistrationEntity getExamRegistration() {
        return examRegistration;
    }

    public void setExamRegistration(ExamRegistrationEntity examRegistration) {
